...
var Extensions = map[uint16]struct {
	...
	Private   bool
	Reference string
}{Name: "server_name", Reserved: false, Grease: false, Private: false, Reference: "[RFC6066][RFC9261]"}, 0x1: struct {
	Name      string
	Reserved  bool
	Grease    bool
	Private   bool
	...
	Private   bool
	Reference string
}{Name: "delegated_credential", Reserved: false, Grease: false, Private: false, Reference: "[RFC9345]"}, 0x23: struct {
	Name      string
	Reserved  bool
	Grease    bool
	Private   bool
	...
	Private   bool
	Reference string
}{Name: "dnssec_chain", Reserved: false, Grease: false, Private: false, Reference: "[RFC9102][RFC Errata 6860]"}, 0x3c: struct {
	Name      string
	Reserved  bool
	Grease    bool
	Private   bool
	Reference string
}{Name: "sequence_number_encryption_algorithms", Reserved: false, Grease: false, Private: false, Reference: "[draft-pismenny-tls-dtls-plaintext-sequence-number-01]"}, 0x3d: struct {
	Name      string
	Reserved  bool
	Grease    bool
	Private   bool
	Reference string
}{Name: "rrc", Reserved: false, Grease: false, Private: false, Reference: "[draft-ietf-tls-dtls-rrc-10]"}, 0xa0a: struct {
	Name      string
	Reserved  bool
	Grease    bool
	Private   bool
	...
	Private   bool
	Reference string
}{Name: "", Reserved: true, Grease: true, Private: false, Reference: "[RFC8701]"}, 0xfd00: struct {
	Name      string
	Reserved  bool
	Grease    bool
	Private   bool
	Reference string
}{Name: "ech_outer_extensions", Reserved: false, Grease: false, Private: false, Reference: "[draft-ietf-tls-esni-17]"}, 0xfe0d: struct {
	Name      string
	Reserved  bool
	Grease    bool
	Private   bool
	Reference string
}{Name: "encrypted_client_hello", Reserved: false, Grease: false, Private: false, Reference: "[draft-ietf-tls-esni-17]"}, 0xff00: struct {
	Name      string
	Reserved  bool
	Grease    bool
	Private   bool
